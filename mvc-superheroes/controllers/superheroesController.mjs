...
export const obtenerSuperheroePorIDController = (req, res) => {
    const { id } = req.params;
...
export const buscarSuperheroesPorAtributoController = (req, res) => {
...
export const obtenerSuperheroesMayoresDe30Controller = (req, res) => {
